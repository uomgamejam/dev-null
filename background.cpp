...
Background::Background(sf::RenderWindow* thewindow)
{
	...
	if (!backgroundimage[0].LoadFromFile("resource/sprites/background_assets/background_sky.png")
	    || !backgroundimage[1].LoadFromFile("resource/sprites/background_assets/background_grass_bottom.png")
	    || !backgroundimage[2].LoadFromFile("resource/sprites/background_assets/background_mountains_back.png")
	    || !backgroundimage[3].LoadFromFile("resource/sprites/background_assets/background_cloudlayer_middle.png")
	    || !backgroundimage[4].LoadFromFile("resource/sprites/background_assets/background_mountains_middle.png")
